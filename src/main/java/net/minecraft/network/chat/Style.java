...
public class Style {
   ...
   public Style(TextColor textColor){
   ...
   public Style(@Nullable TextColor textColor, @Nullable Boolean bold, @Nullable Boolean italic, @Nullable Boolean underlined, @Nullable Boolean strikethrough, @Nullable Boolean obfuscated, @Nullable ClickEvent clickEvent, @Nullable HoverEvent hoverEvent, @Nullable String insertion, @Nullable ResourceLocation resourceLocation) {
      this.color = textColor;
      this.bold = bold;
      this.italic = italic;
      ...
      this.font = Objects.requireNonNullElseGet(resourceLocation, () -> new ResourceLocation("minecraft", "default"));
   }
