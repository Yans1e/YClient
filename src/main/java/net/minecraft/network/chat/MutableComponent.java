...
public class MutableComponent implements Component {
   ...
   public MutableComponent(ComponentContents p_237200_, List<Component> p_237201_, Style p_237202_) {
   ...
   public static MutableComponent create(ComponentContents p_237205_,Style style) {
      return new MutableComponent(p_237205_, Lists.newArrayList(), style);
   }
