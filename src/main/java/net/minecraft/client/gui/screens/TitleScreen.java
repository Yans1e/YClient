...
public class TitleScreen extends Screen {
   ...
   public static final Component COPYRIGHT_TEXT = Component.literal("");
   //private static final ResourceLocation BACKGROUND_PICTURE = new ResourceLocation("textures/gui/title/background/background.png");
   //private static final ResourceLocation BACKGROUND_PICTURE = new ResourceLocation("../../../../../../de/yansie/client/gui/title/background.png");
   private static final ResourceLocation BACKGROUND_PICTURE = new ResourceLocation("textures/gui/title/background/background.png");
   //private static final ResourceLocation BACKGROUND_PICTURE = new ResourceLocation(".."+ File.separator+".."+ File.separator+"de"+ File.separator+"yansie"+ File.separator+"resources"+ File.separator +"background.png");
   @Nullable
   ...
   protected void init() {
      ...
      if (this.minecraft.isDemo()) {
         ...
         this.createNormalMenuOptions(l-17, 24);
      }
   ...
   private void createNormalMenuOptions(int p_96764_, int p_96765_) {
      ...
      (this.addRenderableWidget(Button.builder(Component.literal("YClient"), (p_210872_) -> {
         minecraft.setScreen(new ModsOnOffScreen(Component.literal("lol"),this));
      }).bounds(this.width / 2 - 100, p_96764_ + p_96765_ * 3, 200, 20).tooltip(tooltip).build())).active = flag;
   ...
   public void render(GuiGraphics p_282860_, int p_281753_, int p_283539_, float p_282628_) {
      ...
      p_282860_.blit(BACKGROUND_PICTURE, 0, 0, this.width, this.height, 0.0F, 0.0F, 16, 128, 16, 128);
      ...
      if ((i & -67108864) != 0) {
         ...
         String s = "YClient " + SharedConstants.getCurrentVersion().getName();
         if (this.minecraft.isDemo()) {
            s = s + " Demo";
         } else {
